...
# RAG Simulation 
def rag_model_call(retrieved_context, user_query, choice_ids, image=None, verbose=False, ctxt_image = None):
    ...
    image_inputs = {}
    if all_images:
        image_inputs = {"images": all_images, "videos": None}
    ...
    if verbose:
        ...
        # Use 'text' here. It is the single source of truth and contains 
        # the context, query, and formatted structure regardless of which path was taken.
        print(text)
